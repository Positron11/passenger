/**
 * Bytewords word list.
 * Source: https://github.com/BlockchainCommons/Research/blob/master/papers/bcr-2020-012-bytewords.md
 */
const BYTEWORDS = [
...
/**
 * Encode byte stream using Bytewords wordlist
 */
export function encodeBytewords(
	bytes,
	{ wordlist = BYTEWORDS, sep = "-" } = {}
) {
	return Array.from(new Uint8Array(bytes), b => wordlist[b].charAt(0).toUpperCase() + wordlist[b].slice(1)).join(sep);
}
